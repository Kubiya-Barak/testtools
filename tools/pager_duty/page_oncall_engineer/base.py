...
def main(description):
    ...
    print(
        'The on-call engineer has been paged. They will reach out to you as soon as possible. '
        'Your PagerDuty incident URL is https://aetnd.pagerduty.com/incidents/{{0}}'.format(pd_incident_id)
    )
